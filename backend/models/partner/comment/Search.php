...
namespace backend\models\partner\comment;

use Yii;
use yii\base\Model;
use yii\data\ActiveDataProvider;
use common\models\partner\Comment;

/**
 * Search represents the model behind the search form about `common\models\partner\Comment`.
 */
